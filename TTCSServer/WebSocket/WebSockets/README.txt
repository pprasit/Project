...
08 Oct 2017: Fixed some bugs:
             Changed Environment.Newline to \r\n
			 Changed File.Exists to !File.Exists for SSL cert file check
			 Ensured that client always masks the payload
			 Limit logging size for large messages
