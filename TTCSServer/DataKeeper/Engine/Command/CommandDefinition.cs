...
namespace DataKeeper.Engine.Command
{
    ...
    public class CommandDefinition
    {
        ...
        {
            return new List<STATIONNAME>() { STATIONNAME.AIRFORCE, STATIONNAME.AUSTRALIA, STATIONNAME.CHACHOENGSAO, STATIONNAME.CHINA, STATIONNAME.NAKHONRATCHASIMA, STATIONNAME.SONGKLA, STATIONNAME.USA, STATIONNAME.ASTROPARK };
        }
    }
}
